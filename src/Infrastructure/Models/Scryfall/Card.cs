    ...
    public class Card : IEquatable<Card>, IMapTo<MagicCard> {
        public void Mapping(Profile profile) {
            var map = profile.CreateMap<Card, MagicCard>()
                .ForMember(m => m.Review, opt => opt.Ignore())
                .ForMember(m => m.Set, opt => opt.Ignore());
        }
        ...
        [JsonProperty("cmc")] public decimal Cmc { get; set; }
        ...
        [JsonProperty("promo_types")] public List<string> PromoTypes { get; set; }
